        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium laudantium fuga ea architecto? Nesciunt, aliquid?</p>
        ...
        <Container>
          ...
          <Row>
            {kelasTerbaru.map((kelas) => {
              return (
                <Col key={kelas.id} className="shadow rounded" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-delay={kelas.delay}>
          ...
          <Row>
            <Col className="text-center" data-aos="fade-up-left" data-aos-duration="1000">
